...
Packet related to a player. The first field of every packet is an hubId that uniquely identifies a player in the hub and never changes during the session.
