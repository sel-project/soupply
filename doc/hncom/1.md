...
* ### Add
	...
	* <a name="player.add.language"></a>**language**
		...
		Client's language, in the same format as [HubInfo.language](#login_hub-info_language), which should be updated from the node when the client changes it.
	...
	* <a name="player.add.pocket"></a>**Pocket**
		...
		**Additional Fields**:
		...
		[deviceOs](#player.add.pocket.device-os) | byte
