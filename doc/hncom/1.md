...
* ### Connection Response
	...
	**Fields**:
	...
	Name | Type | When
	---|---|:---:
	[protocolAccepted](#login.connection-response.protocol-accepted) | bool | 
	[nameAccepted](#login.connection-response.name-accepted) | bool | 
	[reason](#login.connection-response.reason) | string | `nameAccepted` is `false`

	* <a name="login.connection-response.protocol-accepted"></a>**protocolAccepted**
	...
	* <a name="login.connection-response.reason"></a>**reason**
