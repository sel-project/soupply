...
* ### Resource Packs Info
	...
	**Fields**:
	...
	---|---
	mustAccept | bool
	behaviourPacks | [pack](#pack)[]
	resourcePacks | [pack](#pack)[]
...
* ### Explode
	...
	**Fields**:
	...
	position | float\<xyz\>
	radius | float
	destroyedBlocks | [blockPosition](#block-position)[]
...
* ### Use Item
	...
	**Fields**:
	...
	Name | Type
	---|---
	blockPosition | [blockPosition](#block-position)
	hotbarSlot | varuint
	face | varint
...
Base | Length | Length's endianness
---|---|---
ubyte | ushort | little endian
...
---|---|:---:|:---:|---|:---:
[Entity Flags](#metadata.entity-flags) | varlong | 0 | 0 | 1073741824 | ✓
Variant | varint | 2 | 2 |  | 
Color | byte | 3 | 3 |  | 
Nametag | string | 4 | 4 |  | 
Owner | varlong | 5 | 5 | -1 | 
Air | short | 7 | 7 | 300 | 
Potion Color | varint | 8 | 8 |  | 
Potion Ambient | byte | 9 | 9 |  | 
Size | byte | 16 | 10 |  | 
[Player Flags](#metadata.player-flags) | byte | 27 | 1B |  | 
Player Index | varint | 28 | 1C |  | 
Bed Position | varint\<xyz\> | 29 | 1D |  | 
Lead Holder | varlong | 38 | 26 | -1 | ✓
Scale | float | 39 | 27 | 1 | 
Interactive Tag | string | 40 | 28 |  | 
Interactive Tag Url | string | 43 | 2B |  | 
Max Air | short | 44 | 2C |  | 
Mark Variant | varint | 45 | 2D |  | 
Bounding Box Width | float | 54 | 36 |  | 
Bounding Box Height | float | 55 | 37 |  | 
Fuse Length | varint | 56 | 38 |  | 
