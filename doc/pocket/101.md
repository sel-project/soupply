...
* ### Login
	...
	**Fields**:
	...
	Name | Type
	---|---
	[protocol](#play.login.protocol) | uint
	[edition](#play.login.edition) | ubyte
	[body](#play.login.body) | ubyte[]

	* <a name="play.login.protocol"></a>**protocol**
...
* ### Show Credits
	...
	**Serverbound**: yes
	...
	Shows the end credits to the player. They are always skippable client-side and a packet of this type is sent back by the client when the credits are skipped or finished.
...
* ### Transfer
	...
	**Fields**:
	...
	---|---|:---:
	[ip](#play.transfer.ip) | string | 
	[port](#play.transfer.port) | ushort | little endian

	* <a name="play.transfer.ip"></a>**ip**
	...
	* <a name="play.transfer.port"></a>**port**
...
* ### Slot
	...
	**Fields**:
	...
	---|---|:---
	[id](#slot.id) | varint | 
	[metaAndCount](#slot.meta-and-count) | varint | `id` is greater than `0`
	[nbt](#slot.nbt) | [slotNbt](#types.slot-nbt) | `id` is greater than `0`

	* <a name="slot.id"></a>**id**

		Item's id or 0 if the slot is empty.

	* <a name="slot.meta-and-count"></a>**metaAndCount**
