...
The websocket protocol uses json packets instead of binary ones and encodes the arrays of bytes ([AuthCredentials.payload](#login.auth-credentials.payload) and [Auth.hash](#login.auth.hash)) into strings using base64.
