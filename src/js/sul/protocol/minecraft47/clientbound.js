...
const Clientbound = {
	...
	EntityEquipment: class extends Buffer {
		...
		// slot
		static get HAND(){ return 0; }
		static get BOOTS(){ return 1; }
		static get LEGGINGS(){ return 2; }
		static get CHESTPLATE(){ return 3; }
		static get HELMET(){ return 4; }
	...
	PlayerPositionAndLook: class extends Buffer {
		...
		constructor(position={x:0,y:0,z:0}, yaw=.0, pitch=.0, flags=0) {
			super();
			this.position = position;
			this.yaw = yaw;
			this.pitch = pitch;
		...
		/** @return {string} */
		toString() {
			return "PlayerPositionAndLook(position: " + this.position + ", yaw: " + this.yaw + ", pitch: " + this.pitch + ", flags: " + this.flags + ")";
		}
	...
	SpawnPlayer: class extends Buffer {
		...
		encode() {
			...
			this.writeBigEndianShort(this.currentItem);
		...
		/** @return {string} */
		toString() {
			return "SpawnPlayer(entityId: " + this.entityId + ", uuid: " + this.uuid + ", position: " + this.position + ", yaw: " + this.yaw + ", pitch: " + this.pitch + ", currentItem: " + this.currentItem + ", metadata: " + this.metadata + ")";
		}
	...
	SpawnObject: class extends Buffer {
		...
		constructor(entityId=0, type=0, position={x:0,y:0,z:0}, pitch=0, yaw=0, data=0, velocity={x:0,y:0,z:0}) {
			super();
			this.entityId = entityId;
			this.type = type;
			this.position = position;
		...
		/** @return {string} */
		toString() {
			return "SpawnObject(entityId: " + this.entityId + ", type: " + this.type + ", position: " + this.position + ", pitch: " + this.pitch + ", yaw: " + this.yaw + ", data: " + this.data + ", velocity: " + this.velocity + ")";
		}
	...
	SpawnMob: class extends Buffer {
		...
		/** @return {string} */
		toString() {
			return "SpawnMob(entityId: " + this.entityId + ", type: " + this.type + ", position: " + this.position + ", yaw: " + this.yaw + ", pitch: " + this.pitch + ", headPitch: " + this.headPitch + ", velocity: " + this.velocity + ", metadata: " + this.metadata + ")";
		}
	...
	SpawnPainting: class extends Buffer {
		...
		constructor(entityId=0, title="", position=0, direction=0) {
			super();
			this.entityId = entityId;
			this.title = title;
			this.position = position;
	...
	EntityRelativeMove: class extends Buffer {
		...
		encode() {
			...
			this.writeVaruint(this.entityId);
			this.writeBigEndianByte(this.delta.x); this.writeBigEndianByte(this.delta.y); this.writeBigEndianByte(this.delta.z);
	...
	AttachEntity: class extends Buffer {
		...
		constructor(target=0, holder=0, leash=false) {
			super();
			this.target = target;
			this.holder = holder;
			this.leash = leash;
		...
		encode() {
			...
			this.writeBigEndianByte(this.leash?1:0);
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			...
			this.leash=this.readBigEndianByte()!==0;
			return this;
		}
	...
	ChunkData: class extends Buffer {
		...
		encode() {
			...
			this.writeBigEndianShort(this.sections);
	...
	SoundEffect: class extends Buffer {
		...
		constructor(soundName="", position={x:0,y:0,z:0}, volume=.0, pitch=0) {
			super();
		...
		encode() {
			...
			var dghpcy5zb3vuze5h=this.encodeString(this.soundName); this.writeVaruint(dghpcy5zb3vuze5h.length); this.writeBytes(dghpcy5zb3vuze5h);
			this.writeBigEndianInt(this.position.x); this.writeBigEndianInt(this.position.y); this.writeBigEndianInt(this.position.z);
		...
		/** @return {string} */
		toString() {
			return "SoundEffect(soundName: " + this.soundName + ", position: " + this.position + ", volume: " + this.volume + ", pitch: " + this.pitch + ")";
		}
	...
	OpenWindow: class extends Buffer {
		...
		constructor(window=0, type="", title="", slots=0, horseId=0) {
			super();
			this.window = window;
			this.type = type;
			this.title = title;
		...
		encode() {
			...
			this.writeBigEndianInt(this.horseId);
			return new Uint8Array(this._buffer);
		}
	...
	Map: class extends Buffer {
		...
		constructor(mapId=0, scale=0, icons=[], colums=0, rows=0, offset={x:0,z:0}, data=[]) {
			super();
			this.mapId = mapId;
			this.scale = scale;
			this.icons = icons;
		...
		/** @return {string} */
		toString() {
			return "Map(mapId: " + this.mapId + ", scale: " + this.scale + ", icons: " + this.icons + ", colums: " + this.colums + ", rows: " + this.rows + ", offset: " + this.offset + ", data: " + this.data + ")";
		}
		...
		decode(_buffer) {
			...
			switch(this.action) {
				...
				case 1:
					...
					break;
				case 2:
					this.center={}; this.center.x=this.readBigEndianDouble(); this.center.z=this.readBigEndianDouble();
					break;
				case 3:
					this.center={}; this.center.x=this.readBigEndianDouble(); this.center.z=this.readBigEndianDouble();
					this.oldDiameter=this.readBigEndianDouble();
	...
	UpdateEntityNbt: class extends Buffer {
		...
		constructor(entityId=0, nbt=null) {
			super();
			this.entityId = entityId;
			this.nbt = nbt;
		}
		...
		/** @param {(Uint8Array|Array)} buffer */
		static fromBuffer(buffer) {
			return new Clientbound.UpdateEntityNbt().decode(buffer);
		}

		/** @return {string} */
		toString() {
			return "UpdateEntityNbt(entityId: " + this.entityId + ", nbt: " + this.nbt + ")";
		}
