...
public class Text extends Packet {
	...
	public class Raw extends Packet {
		...
		@Override
		public int length() {
			return Var.Uint.length(message.getBytes(StandardCharsets.UTF_8).length) + message.getBytes(StandardCharsets.UTF_8).length;
		}
	...
	public class Chat extends Packet {
		...
		@Override
		public int length() {
			return Var.Uint.length(sender.getBytes(StandardCharsets.UTF_8).length) + sender.getBytes(StandardCharsets.UTF_8).length + Var.Uint.length(message.getBytes(StandardCharsets.UTF_8).length) + message.getBytes(StandardCharsets.UTF_8).length;
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			int bgvuc2vuzgvy=varuint.decode(_buffer, _index); sender=new String(this.readBytes(bgvuc2vuzgvy), StandardCharsets.UTF_8);
			int bgvubwvzc2fnzq=varuint.decode(_buffer, _index); message=new String(this.readBytes(bgvubwvzc2fnzq), StandardCharsets.UTF_8);
		}
	...
	public class Translation extends Packet {
		...
		@Override
		public int length() {
			int length=Var.Uint.length(message.getBytes(StandardCharsets.UTF_8).length) + message.getBytes(StandardCharsets.UTF_8).length + Var.Uint.length(parameters.length) + 0; for(String cgfyyw1ldgvycw:parameters){ length+=Var.Uint.length(cgfyyw1ldgvycw.getBytes(StandardCharsets.UTF_8).length)+cgfyyw1ldgvycw.getBytes(StandardCharsets.UTF_8).length; } return length;
		}
	...
	public class Popup extends Packet {
		...
		@Override
		public int length() {
			return Var.Uint.length(title.getBytes(StandardCharsets.UTF_8).length) + title.getBytes(StandardCharsets.UTF_8).length + Var.Uint.length(subtitle.getBytes(StandardCharsets.UTF_8).length) + subtitle.getBytes(StandardCharsets.UTF_8).length;
		}
		...
		public void decode(byte[] buffer) {
			...
			int bgvuc3vidgl0bgu=varuint.decode(_buffer, _index); subtitle=new String(this.readBytes(bgvuc3vidgl0bgu), StandardCharsets.UTF_8);
		}
