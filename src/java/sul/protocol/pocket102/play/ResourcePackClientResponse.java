...
public class ResourcePackClientResponse extends Packet {
	...
	public ResourcePackClientResponse(byte status, sul.protocol.pocket102.types.Packs packIds) {
		this.status = status;
	...
	public void decode(byte[] buffer) {
		...
		packIds=new sul.protocol.pocket102.types.Packs(); packIds._index=this._index; packIds.decode(this._buffer); this._index=packIds._index;
	}
