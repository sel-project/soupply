...
public class NodeStats extends Packet {
	...
	public byte[] encode() {
		...
		byte[] bmftzq=name.getBytes(StandardCharsets.UTF_8); this.writeBigEndianShort((short)bmftzq.length); this.writeBytes(bmftzq);
	...
	public void decode(byte[] buffer) {
		this._buffer = buffer;
		short bgvubmftzq=readBigEndianShort(); name=new String(this.readBytes(bgvubmftzq), StandardCharsets.UTF_8);
