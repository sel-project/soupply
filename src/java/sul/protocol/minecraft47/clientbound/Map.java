...
public class Map extends Packet {
	...
	public byte[] encode() {
		...
		this.writeVaruint((int)icons.length); for(sul.protocol.minecraft47.types.Icon anbm:icons){ this.writeBytes(anbm.encode()); }
	...
	public void decode(byte[] buffer) {
		...
		int blb5=this.readVaruint(); icons=new sul.protocol.minecraft47.types.Icon[blb5]; for(int anbm=0;anbm<icons.length;anbm++){ icons[anbm]=new sul.protocol.minecraft47.types.Icon(); icons[anbm]._index=this._index; icons[anbm].decode(this._buffer); this._index=icons[anbm]._index; }
	...
	public String toString() {
		return "Map(mapId: " + this.mapId + ", scale: " + this.scale + ", icons: " + Arrays.deepToString(this.icons) + ", colums: " + this.colums + ", rows: " + this.rows + ", offset: " + this.offset.toString() + ", data: " + Arrays.toString(this.data) + ")";
	}
