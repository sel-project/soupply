...
public class WorldBorder extends Packet {
	...
	public class SetCenter extends Packet {
		...
		public Tuples.DoubleXZ center = new Tuples.DoubleXZ();

		public SetCenter() {}

		public SetCenter(Tuples.DoubleXZ center) {
			this.center = center;
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			center=new Tuples.DoubleXZ(); center.x=readBigEndianDouble(); center.z=readBigEndianDouble();
		}
	...
	public class Initialize extends Packet {
		...
		public Initialize(Tuples.DoubleXZ center, double oldDiameter, double newDiameter, long speed, int portalTeleportBoundary, int warningTime, int warningBlocks) {
			this.center = center;
			this.oldDiameter = oldDiameter;
			this.newDiameter = newDiameter;
			this.speed = speed;
