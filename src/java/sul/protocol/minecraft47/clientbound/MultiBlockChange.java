...
public class MultiBlockChange extends Packet {
	...
	public byte[] encode() {
		...
		this.writeVaruint((int)changes.length); for(sul.protocol.minecraft47.types.BlockChange yhbdc:changes){ this.writeBytes(yhbdc.encode()); }
	...
	public void decode(byte[] buffer) {
		...
		int bny5zm=this.readVaruint(); changes=new sul.protocol.minecraft47.types.BlockChange[bny5zm]; for(int yhbdc=0;yhbdc<changes.length;yhbdc++){ changes[yhbdc]=new sul.protocol.minecraft47.types.BlockChange(); changes[yhbdc]._index=this._index; changes[yhbdc].decode(this._buffer); this._index=changes[yhbdc]._index; }
	}
