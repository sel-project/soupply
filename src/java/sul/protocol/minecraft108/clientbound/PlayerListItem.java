...
public class PlayerListItem extends Packet {
	...
	public class AddPlayer extends Packet {
		...
		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length) + 0; for(sul.protocol.minecraft108.types.ListAddPlayer cxevc:players){ length+=cxevc.length(); } return length;
		}
	...
	public class UpdateGamemode extends Packet {
		...
		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length) + 0; for(sul.protocol.minecraft108.types.ListUpdateGamemode cxevc:players){ length+=cxevc.length(); } return length;
		}
	...
	public class UpdateLatency extends Packet {
		...
		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length) + 0; for(sul.protocol.minecraft108.types.ListUpdateLatency cxevc:players){ length+=cxevc.length(); } return length;
		}
	...
	public class UpdateDisplayName extends Packet {
		...
		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length) + 0; for(sul.protocol.minecraft108.types.ListUpdateDisplayName cxevc:players){ length+=cxevc.length(); } return length;
		}
