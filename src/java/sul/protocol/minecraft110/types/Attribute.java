...
public class Attribute extends Packet {
	...
	public String key;
	public double value;
	public sul.protocol.minecraft110.types.Modifier[] modifiers;
	...
	@Override
	public int length() {
		int length=Buffer.varuintLength(key.getBytes(StandardCharsets.UTF_8).length) + key.getBytes(StandardCharsets.UTF_8).length + Buffer.varuintLength(modifiers.length) + 8; for(sul.protocol.minecraft110.types.Modifier bw9kawzpzxjz:modifiers){ length+=bw9kawzpzxjz.length(); } return length;
	}
	...
	public byte[] encode() {
		...
		this.writeVaruint((int)modifiers.length); for(sul.protocol.minecraft110.types.Modifier bw9kawzpzxjz:modifiers){ this.writeBytes(bw9kawzpzxjz.encode()); }
