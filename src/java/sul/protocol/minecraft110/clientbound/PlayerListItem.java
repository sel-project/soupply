...
public class PlayerListItem extends Packet {
	...
	public class AddPlayer extends Packet {
		...
		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length) + 0; for(sul.protocol.minecraft110.types.ListAddPlayer cgxhewvycw:players){ length+=cgxhewvycw.length(); } return length;
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			int bhbsyxllcnm=this.readVaruint(); players=new sul.protocol.minecraft110.types.ListAddPlayer[bhbsyxllcnm]; for(int cgxhewvycw=0;cgxhewvycw<players.length;cgxhewvycw++){ players[cgxhewvycw]=new sul.protocol.minecraft110.types.ListAddPlayer(); players[cgxhewvycw]._index=this._index; players[cgxhewvycw].decode(this._buffer); this._index=players[cgxhewvycw]._index; }
		}
	...
	public class UpdateGamemode extends Packet {
		...
		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length) + 0; for(sul.protocol.minecraft110.types.ListUpdateGamemode cgxhewvycw:players){ length+=cgxhewvycw.length(); } return length;
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			int bhbsyxllcnm=this.readVaruint(); players=new sul.protocol.minecraft110.types.ListUpdateGamemode[bhbsyxllcnm]; for(int cgxhewvycw=0;cgxhewvycw<players.length;cgxhewvycw++){ players[cgxhewvycw]=new sul.protocol.minecraft110.types.ListUpdateGamemode(); players[cgxhewvycw]._index=this._index; players[cgxhewvycw].decode(this._buffer); this._index=players[cgxhewvycw]._index; }
		}
	...
	public class UpdateLatency extends Packet {
		...
		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length) + 0; for(sul.protocol.minecraft110.types.ListUpdateLatency cgxhewvycw:players){ length+=cgxhewvycw.length(); } return length;
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			int bhbsyxllcnm=this.readVaruint(); players=new sul.protocol.minecraft110.types.ListUpdateLatency[bhbsyxllcnm]; for(int cgxhewvycw=0;cgxhewvycw<players.length;cgxhewvycw++){ players[cgxhewvycw]=new sul.protocol.minecraft110.types.ListUpdateLatency(); players[cgxhewvycw]._index=this._index; players[cgxhewvycw].decode(this._buffer); this._index=players[cgxhewvycw]._index; }
		}
	...
	public class UpdateDisplayName extends Packet {
		...
		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length) + 0; for(sul.protocol.minecraft110.types.ListUpdateDisplayName cgxhewvycw:players){ length+=cgxhewvycw.length(); } return length;
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			int bhbsyxllcnm=this.readVaruint(); players=new sul.protocol.minecraft110.types.ListUpdateDisplayName[bhbsyxllcnm]; for(int cgxhewvycw=0;cgxhewvycw<players.length;cgxhewvycw++){ players[cgxhewvycw]=new sul.protocol.minecraft110.types.ListUpdateDisplayName(); players[cgxhewvycw]._index=this._index; players[cgxhewvycw].decode(this._buffer); this._index=players[cgxhewvycw]._index; }
		}
