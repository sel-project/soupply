...
public class OpenConnectionReply2 extends Packet {
	...
	public OpenConnectionReply2(byte[] magic, long serverId, Address clientAddress, short mtuLength, boolean security) {
		this.magic = magic;
	...
	@Override
	public int length() {
		return magic.length + clientAddress.length() + 12;
	}
