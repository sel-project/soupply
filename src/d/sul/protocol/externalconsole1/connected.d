...
class ConsoleMessage : Buffer {
	 ...
	 * by the hub or by a server implementation that isn't based on the hub-node layout.
	 */
	public string node;
	 ...
	 * The logs may not arrive in order when the server uses the hub-node layout or another
	 * kind of proxy because the logs created by the nodes have to travel a longer distance,
