...
class ResourcePacksInfo : Buffer {
	...
	public sul.protocol.pocket105.types.PackWithSize[] behaviourPacks;
	public sul.protocol.pocket105.types.PackWithSize[] resourcePacks;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(bool mustAccept, sul.protocol.pocket105.types.PackWithSize[] behaviourPacks=(sul.protocol.pocket105.types.PackWithSize[]).init, sul.protocol.pocket105.types.PackWithSize[] resourcePacks=(sul.protocol.pocket105.types.PackWithSize[]).init) {
...
class ResourcePacksStackPacket : Buffer {
	...
	public bool mustAccept;
	public sul.protocol.pocket105.types.Pack[] behaviourPacks;
	public sul.protocol.pocket105.types.Pack[] resourcePacks;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(bool mustAccept, sul.protocol.pocket105.types.Pack[] behaviourPacks=(sul.protocol.pocket105.types.Pack[]).init, sul.protocol.pocket105.types.Pack[] resourcePacks=(sul.protocol.pocket105.types.Pack[]).init) {
		this.mustAccept = mustAccept;
		this.behaviourPacks = behaviourPacks;
		this.resourcePacks = resourcePacks;
	}
...
class AddEntity : Buffer {
	...
	public float pitch;
	public float yaw;
	public sul.protocol.pocket105.types.Attribute[] attributes;
	public Metadata metadata;
	public sul.protocol.pocket105.types.Link[] links;
...
class AddItemEntity : Buffer {
	...
	public pure nothrow @safe @nogc this(long entityId, long runtimeId=long.init, sul.protocol.pocket105.types.Slot item=sul.protocol.pocket105.types.Slot.init, Tuple!(float, "x", float, "y", float, "z") position=Tuple!(float, "x", float, "y", float, "z").init, Tuple!(float, "x", float, "y", float, "z") motion=Tuple!(float, "x", float, "y", float, "z").init) {
		this.entityId = entityId;
		this.runtimeId = runtimeId;
		this.item = item;
		this.position = position;
...
class AddHangingEntity : Buffer {
	...
	public pure nothrow @safe @nogc this(long entityId, long runtimeId=long.init, sul.protocol.pocket105.types.BlockPosition position=sul.protocol.pocket105.types.BlockPosition.init, int unknown3=int.init) {
		this.entityId = entityId;
		this.runtimeId = runtimeId;
		this.position = position;
...
class RemoveBlock : Buffer {
	...
	public pure nothrow @safe @nogc this(sul.protocol.pocket105.types.BlockPosition position) {
		this.position = position;
	}
...
class UpdateBlock : Buffer {
	...
	public pure nothrow @safe @nogc this(sul.protocol.pocket105.types.BlockPosition position, uint block=uint.init, uint flagsAndMeta=uint.init) {
		this.position = position;
		this.block = block;
...
class AddPainting : Buffer {
	...
	public pure nothrow @safe @nogc this(long entityId, long runtimeId=long.init, sul.protocol.pocket105.types.BlockPosition position=sul.protocol.pocket105.types.BlockPosition.init, int direction=int.init, string title=string.init) {
		this.entityId = entityId;
		this.runtimeId = runtimeId;
		this.position = position;
...
class Explode : Buffer {
	...
	public Tuple!(float, "x", float, "y", float, "z") position;
	public float radius;
	public sul.protocol.pocket105.types.BlockPosition[] destroyedBlocks;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(Tuple!(float, "x", float, "y", float, "z") position, float radius=float.init, sul.protocol.pocket105.types.BlockPosition[] destroyedBlocks=(sul.protocol.pocket105.types.BlockPosition[]).init) {
		this.position = position;
		this.radius = radius;
...
class BlockEvent : Buffer {
	...
	public pure nothrow @safe @nogc this(sul.protocol.pocket105.types.BlockPosition position, int[2] data=(int[2]).init) {
		this.position = position;
		this.data = data;
	}
...
class UpdateAttributes : Buffer {
	...
	public pure nothrow @safe @nogc this(long entityId, sul.protocol.pocket105.types.Attribute[] attributes=(sul.protocol.pocket105.types.Attribute[]).init) {
		this.entityId = entityId;
		this.attributes = attributes;
	}
...
class MobEquipment : Buffer {
	...
	public pure nothrow @safe @nogc this(long entityId, sul.protocol.pocket105.types.Slot item=sul.protocol.pocket105.types.Slot.init, ubyte inventorySlot=ubyte.init, ubyte hotbarSlot=ubyte.init, ubyte unknown4=ubyte.init) {
		this.entityId = entityId;
		this.item = item;
...
class MobArmorEquipment : Buffer {
	...
	public long entityId;
	public sul.protocol.pocket105.types.Slot[4] armor;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(long entityId, sul.protocol.pocket105.types.Slot[4] armor=(sul.protocol.pocket105.types.Slot[4]).init) {
		this.entityId = entityId;
		this.armor = armor;
	}
...
class UseItem : Buffer {
	...
	public pure nothrow @safe @nogc this(sul.protocol.pocket105.types.BlockPosition blockPosition, uint hotbarSlot=uint.init, int face=int.init, Tuple!(float, "x", float, "y", float, "z") facePosition=Tuple!(float, "x", float, "y", float, "z").init, Tuple!(float, "x", float, "y", float, "z") position=Tuple!(float, "x", float, "y", float, "z").init, int slot=int.init, sul.protocol.pocket105.types.Slot item=sul.protocol.pocket105.types.Slot.init) {
...
class PlayerAction : Buffer {
	...
	public pure nothrow @safe @nogc this(long entityId, int action=int.init, sul.protocol.pocket105.types.BlockPosition position=sul.protocol.pocket105.types.BlockPosition.init, int face=int.init) {
		this.entityId = entityId;
		this.action = action;
		this.position = position;
		this.face = face;
...
class SetSpawnPosition : Buffer {
	...
	public pure nothrow @safe @nogc this(int unknown0, sul.protocol.pocket105.types.BlockPosition position=sul.protocol.pocket105.types.BlockPosition.init, bool unknown2=bool.init) {
		this.unknown0 = unknown0;
		this.position = position;
		this.unknown2 = unknown2;
	}
...
class DropItem : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte action, sul.protocol.pocket105.types.Slot item=sul.protocol.pocket105.types.Slot.init) {
		this.action = action;
		this.item = item;
	}
...
class InventoryAction : Buffer {
	...
	public pure nothrow @safe @nogc this(int action, sul.protocol.pocket105.types.Slot item=sul.protocol.pocket105.types.Slot.init) {
		this.action = action;
		this.item = item;
	}
...
class ContainerOpen : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte window, ubyte type=ubyte.init, int slotCount=int.init, sul.protocol.pocket105.types.BlockPosition position=sul.protocol.pocket105.types.BlockPosition.init, long entityId=long.init) {
		this.window = window;
		this.type = type;
...
class ContainerSetSlot : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte window, int slot=int.init, int hotbarSlot=int.init, sul.protocol.pocket105.types.Slot item=sul.protocol.pocket105.types.Slot.init, ubyte unknown4=ubyte.init) {
		this.window = window;
		this.slot = slot;
		this.hotbarSlot = hotbarSlot;
		this.item = item;
...
class ContainerSetContent : Buffer {
	...
	public ubyte window;
	public sul.protocol.pocket105.types.Slot[] slots;
	public int[] hotbar;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(ubyte window, sul.protocol.pocket105.types.Slot[] slots=(sul.protocol.pocket105.types.Slot[]).init, int[] hotbar=(int[]).init) {
		this.window = window;
		this.slots = slots;
		this.hotbar = hotbar;
	}
...
class CraftingData : Buffer {
	...
	public sul.protocol.pocket105.types.Recipe[] recipes;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(sul.protocol.pocket105.types.Recipe[] recipes) {
...
class CraftingEvent : Buffer {
	...
	public int type;
	public UUID uuid;
	public sul.protocol.pocket105.types.Slot[] input;
	public sul.protocol.pocket105.types.Slot[] output;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(ubyte window, int type=int.init, UUID uuid=UUID.init, sul.protocol.pocket105.types.Slot[] input=(sul.protocol.pocket105.types.Slot[]).init, sul.protocol.pocket105.types.Slot[] output=(sul.protocol.pocket105.types.Slot[]).init) {
		this.window = window;
		this.type = type;
		this.uuid = uuid;
		this.input = input;
...
class BlockEntityData : Buffer {
	...
	public pure nothrow @safe @nogc this(sul.protocol.pocket105.types.BlockPosition position, ubyte[] nbt=(ubyte[]).init) {
		this.position = position;
		this.nbt = nbt;
	}
...
class FullChunkData : Buffer {
	...
	public pure nothrow @safe @nogc this(Tuple!(int, "x", int, "z") position, sul.protocol.pocket105.types.ChunkData data=sul.protocol.pocket105.types.ChunkData.init) {
		this.position = position;
		this.data = data;
	}
...
class PlayerList : Buffer {
	...
	public class Add {
		...
		public sul.protocol.pocket105.types.PlayerList[] players;

		public pure nothrow @safe @nogc this() {}

		public pure nothrow @safe @nogc this(sul.protocol.pocket105.types.PlayerList[] players) {
...
class ClientboundMapItemData : Buffer {
	 ...
	 */
	public ubyte[] data;
	public sul.protocol.pocket105.types.Decoration[] decorations;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(long mapId, uint update=uint.init, ubyte scale=ubyte.init, Tuple!(int, "x", int, "z") size=Tuple!(int, "x", int, "z").init, Tuple!(int, "x", int, "z") offset=Tuple!(int, "x", int, "z").init, ubyte[] data=(ubyte[]).init, sul.protocol.pocket105.types.Decoration[] decorations=(sul.protocol.pocket105.types.Decoration[]).init) {
		this.mapId = mapId;
		this.update = update;
		this.scale = scale;
		this.size = size;
...
class ItemFrameDropItem : Buffer {
	...
	public pure nothrow @safe @nogc this(sul.protocol.pocket105.types.BlockPosition position, sul.protocol.pocket105.types.Slot item=sul.protocol.pocket105.types.Slot.init) {
		this.position = position;
		this.item = item;
	}
...
class ReplaceItemInSlot : Buffer {
	...
	public pure nothrow @safe @nogc this(sul.protocol.pocket105.types.Slot item) {
		this.item = item;
	}
...
class GameRulesChanged : Buffer {
	...
	public sul.protocol.pocket105.types.Rule[] rules;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(sul.protocol.pocket105.types.Rule[] rules) {
		this.rules = rules;
	}
...
class PlaySound : Buffer {
	...
	public pure nothrow @safe @nogc this(string unknown0, sul.protocol.pocket105.types.BlockPosition position=sul.protocol.pocket105.types.BlockPosition.init, float unknown2=float.init, float unknown3=float.init) {
		this.unknown0 = unknown0;
		this.position = position;
		this.unknown2 = unknown2;
		this.unknown3 = unknown3;
