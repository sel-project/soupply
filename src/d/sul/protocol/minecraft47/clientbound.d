...
struct SpawnPlayer {
	...
	public ubyte[] encode(bool writeId=true)() {
		...
		_buffer~=yaw;
		_buffer~=pitch;
		_buffer.length+=ushort.sizeof; write!(ushort, Endian.bigEndian)(_buffer, currentItem, _buffer.length-ushort.sizeof);
	...
	public typeof(this) decode(bool readId=true)(ubyte[] _buffer, size_t* _index) {
		...
		if(_buffer.length>=*_index+ushort.sizeof){ currentItem=peek!(ushort, Endian.bigEndian)(_buffer, _index); }
...
struct EntityRelativeMove {
	...
	public ubyte[] encode(bool writeId=true)() {
		...
		static if(writeId){ _buffer~=varuint.encode(ID); }
		_buffer~=varuint.encode(entityId);
		_buffer.length+=byte.sizeof; write!(byte, Endian.bigEndian)(_buffer, delta.x, _buffer.length-byte.sizeof);_buffer.length+=byte.sizeof; write!(byte, Endian.bigEndian)(_buffer, delta.y, _buffer.length-byte.sizeof);_buffer.length+=byte.sizeof; write!(byte, Endian.bigEndian)(_buffer, delta.z, _buffer.length-byte.sizeof);
	...
	public typeof(this) decode(bool readId=true)(ubyte[] _buffer, size_t* _index) {
		static if(readId){ typeof(ID) _id; _id=varuint.decode(_buffer, *_index); }
		entityId=varuint.decode(_buffer, *_index);
		if(_buffer.length>=*_index+byte.sizeof){ delta.x=peek!(byte, Endian.bigEndian)(_buffer, _index); }if(_buffer.length>=*_index+byte.sizeof){ delta.y=peek!(byte, Endian.bigEndian)(_buffer, _index); }if(_buffer.length>=*_index+byte.sizeof){ delta.z=peek!(byte, Endian.bigEndian)(_buffer, _index); }
...
struct AttachEntity {
	...
	public ubyte[] encode(bool writeId=true)() {
		...
		_buffer.length+=bool.sizeof; write!(bool, Endian.bigEndian)(_buffer, leash, _buffer.length-bool.sizeof);
		return _buffer;
	}
	...
	public typeof(this) decode(bool readId=true)(ubyte[] _buffer, size_t* _index) {
		...
		if(_buffer.length>=*_index+bool.sizeof){ leash=peek!(bool, Endian.bigEndian)(_buffer, _index); }
		return this;
	}
...
struct ChunkData {
	...
	public ubyte[] encode(bool writeId=true)() {
		...
		_buffer.length+=ushort.sizeof; write!(ushort, Endian.bigEndian)(_buffer, sections, _buffer.length-ushort.sizeof);
	...
	public typeof(this) decode(bool readId=true)(ubyte[] _buffer, size_t* _index) {
		...
		if(_buffer.length>=*_index+ushort.sizeof){ sections=peek!(ushort, Endian.bigEndian)(_buffer, _index); }
...
struct SoundEffect {
	...
	public ubyte[] encode(bool writeId=true)() {
		ubyte[] _buffer;
		static if(writeId){ _buffer~=varuint.encode(ID); }
		ubyte[] c291bmROYW1l=cast(ubyte[])soundName; _buffer~=varuint.encode(c291bmROYW1l.length.to!uint); _buffer~=c291bmROYW1l;
		_buffer.length+=int.sizeof; write!(int, Endian.bigEndian)(_buffer, position.x, _buffer.length-int.sizeof);_buffer.length+=int.sizeof; write!(int, Endian.bigEndian)(_buffer, position.y, _buffer.length-int.sizeof);_buffer.length+=int.sizeof; write!(int, Endian.bigEndian)(_buffer, position.z, _buffer.length-int.sizeof);
	...
	public typeof(this) decode(bool readId=true)(ubyte[] _buffer, size_t* _index) {
		static if(readId){ typeof(ID) _id; _id=varuint.decode(_buffer, *_index); }
		ubyte[] c291bmROYW1l; c291bmROYW1l.length=varuint.decode(_buffer, *_index); if(_buffer.length>=*_index+c291bmROYW1l.length){ c291bmROYW1l=_buffer[*_index..*_index+c291bmROYW1l.length].dup; *_index+=c291bmROYW1l.length; }; soundName=cast(string)c291bmROYW1l;
		if(_buffer.length>=*_index+int.sizeof){ position.x=peek!(int, Endian.bigEndian)(_buffer, _index); }if(_buffer.length>=*_index+int.sizeof){ position.y=peek!(int, Endian.bigEndian)(_buffer, _index); }if(_buffer.length>=*_index+int.sizeof){ position.z=peek!(int, Endian.bigEndian)(_buffer, _index); }
...
struct OpenWindow {
	...
	public ubyte[] encode(bool writeId=true)() {
		...
		ubyte[] dGl0bGU=cast(ubyte[])title; _buffer~=varuint.encode(dGl0bGU.length.to!uint); _buffer~=dGl0bGU;
		_buffer~=slots;
		_buffer.length+=uint.sizeof; write!(uint, Endian.bigEndian)(_buffer, horseId, _buffer.length-uint.sizeof);
		return _buffer;
	}
	...
	public typeof(this) decode(bool readId=true)(ubyte[] _buffer, size_t* _index) {
		...
		if(_buffer.length>=*_index+uint.sizeof){ horseId=peek!(uint, Endian.bigEndian)(_buffer, _index); }
		return this;
	}
...
struct WorldBorder {
	...
	public struct SetCenter {
		...
		public ubyte[] encode(ref ubyte[] _buffer) {
			_buffer.length+=double.sizeof; write!(double, Endian.bigEndian)(_buffer, center.x, _buffer.length-double.sizeof);_buffer.length+=double.sizeof; write!(double, Endian.bigEndian)(_buffer, center.z, _buffer.length-double.sizeof);
			return _buffer;
		}

		public typeof(this) decode(ubyte[] _buffer, size_t* _index) {
			if(_buffer.length>=*_index+double.sizeof){ center.x=peek!(double, Endian.bigEndian)(_buffer, _index); }if(_buffer.length>=*_index+double.sizeof){ center.z=peek!(double, Endian.bigEndian)(_buffer, _index); }
			return this;
		}
