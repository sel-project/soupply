...
class PlayerPositionAndLook : Buffer {
	...
	public override string toString() {
		return "PlayerPositionAndLook(position: " ~ std.conv.to!string(this.position) ~ ", yaw: " ~ std.conv.to!string(this.yaw) ~ ", pitch: " ~ std.conv.to!string(this.pitch) ~ ", flags: " ~ std.conv.to!string(this.flags) ~ ")";
	}
...
class SpawnPlayer : Buffer {
	...
	public override string toString() {
		return "SpawnPlayer(entityId: " ~ std.conv.to!string(this.entityId) ~ ", uuid: " ~ std.conv.to!string(this.uuid) ~ ", position: " ~ std.conv.to!string(this.position) ~ ", yaw: " ~ std.conv.to!string(this.yaw) ~ ", pitch: " ~ std.conv.to!string(this.pitch) ~ ", currentItem: " ~ std.conv.to!string(this.currentItem) ~ ", metadata: " ~ std.conv.to!string(this.metadata) ~ ")";
	}
...
class SpawnObject : Buffer {
	...
	public override string toString() {
		return "SpawnObject(entityId: " ~ std.conv.to!string(this.entityId) ~ ", type: " ~ std.conv.to!string(this.type) ~ ", position: " ~ std.conv.to!string(this.position) ~ ", pitch: " ~ std.conv.to!string(this.pitch) ~ ", yaw: " ~ std.conv.to!string(this.yaw) ~ ", data: " ~ std.conv.to!string(this.data) ~ ", velocity: " ~ std.conv.to!string(this.velocity) ~ ")";
	}
...
class SpawnMob : Buffer {
	...
	public override string toString() {
		return "SpawnMob(entityId: " ~ std.conv.to!string(this.entityId) ~ ", type: " ~ std.conv.to!string(this.type) ~ ", position: " ~ std.conv.to!string(this.position) ~ ", yaw: " ~ std.conv.to!string(this.yaw) ~ ", pitch: " ~ std.conv.to!string(this.pitch) ~ ", headPitch: " ~ std.conv.to!string(this.headPitch) ~ ", velocity: " ~ std.conv.to!string(this.velocity) ~ ", metadata: " ~ std.conv.to!string(this.metadata) ~ ")";
	}
...
class SpawnPainting : Buffer {
	...
	public override string toString() {
		return "SpawnPainting(entityId: " ~ std.conv.to!string(this.entityId) ~ ", title: " ~ std.conv.to!string(this.title) ~ ", position: " ~ std.conv.to!string(this.position) ~ ", direction: " ~ std.conv.to!string(this.direction) ~ ")";
	}
...
class AttachEntity : Buffer {
	...
	public override string toString() {
		return "AttachEntity(target: " ~ std.conv.to!string(this.target) ~ ", holder: " ~ std.conv.to!string(this.holder) ~ ", leash: " ~ std.conv.to!string(this.leash) ~ ")";
	}
...
class EntityEffect : Buffer {
	...
	public override string toString() {
		return "EntityEffect(entityId: " ~ std.conv.to!string(this.entityId) ~ ", effectId: " ~ std.conv.to!string(this.effectId) ~ ", amplifier: " ~ std.conv.to!string(this.amplifier) ~ ", duration: " ~ std.conv.to!string(this.duration) ~ ", hideParticles: " ~ std.conv.to!string(this.hideParticles) ~ ")";
	}
...
class SoundEffect : Buffer {
	...
	public override string toString() {
		return "SoundEffect(soundName: " ~ std.conv.to!string(this.soundName) ~ ", position: " ~ std.conv.to!string(this.position) ~ ", volume: " ~ std.conv.to!string(this.volume) ~ ", pitch: " ~ std.conv.to!string(this.pitch) ~ ")";
	}
...
class OpenWindow : Buffer {
	...
	public override string toString() {
		return "OpenWindow(window: " ~ std.conv.to!string(this.window) ~ ", type: " ~ std.conv.to!string(this.type) ~ ", title: " ~ std.conv.to!string(this.title) ~ ", slots: " ~ std.conv.to!string(this.slots) ~ ", horseId: " ~ std.conv.to!string(this.horseId) ~ ")";
	}
...
class Map : Buffer {
	...
	public override string toString() {
		return "Map(mapId: " ~ std.conv.to!string(this.mapId) ~ ", scale: " ~ std.conv.to!string(this.scale) ~ ", icons: " ~ std.conv.to!string(this.icons) ~ ", colums: " ~ std.conv.to!string(this.colums) ~ ", rows: " ~ std.conv.to!string(this.rows) ~ ", offset: " ~ std.conv.to!string(this.offset) ~ ", data: " ~ std.conv.to!string(this.data) ~ ")";
	}
...
class UpdateEntityNbt : Buffer {
	...
	public override string toString() {
		return "UpdateEntityNbt(entityId: " ~ std.conv.to!string(this.entityId) ~ ", nbt: " ~ std.conv.to!string(this.nbt) ~ ")";
	}
