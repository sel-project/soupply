...
import types = sul.protocol.minecraft110.types;
...
struct EntityEffect {
	...
	public ubyte[] encode(bool writeId=true)() {
		...
		_buffer~=amplifier;
		_buffer~=varuint.encode(duration);
		_buffer.length+=bool.sizeof; write!(bool, Endian.bigEndian)(_buffer, showParticles, _buffer.length-bool.sizeof);
		return _buffer;
	}
	...
	public typeof(this) decode(bool readId=true)(ubyte[] _buffer, size_t* _index) {
		...
		duration=varuint.decode(_buffer, *_index);
		if(_buffer.length>=*_index+bool.sizeof){ showParticles=peek!(bool, Endian.bigEndian)(_buffer, _index); }
		return this;
	}
