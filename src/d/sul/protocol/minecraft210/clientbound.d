...
class SpawnMob : Buffer {
	...
	public Tuple!(short, "x", short, "y", short, "z") velocity;
	public sul.protocol.minecraft210.types.Metadata metadata;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(uint entityId, UUID uuid=UUID.init, ubyte type=ubyte.init, Tuple!(double, "x", double, "y", double, "z") position=Tuple!(double, "x", double, "y", double, "z").init, ubyte yaw=ubyte.init, ubyte pitch=ubyte.init, ubyte headPitch=ubyte.init, Tuple!(short, "x", short, "y", short, "z") velocity=Tuple!(short, "x", short, "y", short, "z").init, sul.protocol.minecraft210.types.Metadata metadata=sul.protocol.minecraft210.types.Metadata.init) {
		this.entityId = entityId;
		this.uuid = uuid;
		this.type = type;
		this.position = position;
...
class SpawnPlayer : Buffer {
	...
	public pure nothrow @safe @nogc this(uint entityId, UUID uuid=UUID.init, Tuple!(double, "x", double, "y", double, "z") position=Tuple!(double, "x", double, "y", double, "z").init, ubyte yaw=ubyte.init, ubyte pitch=ubyte.init, sul.protocol.minecraft210.types.Metadata metadata=sul.protocol.minecraft210.types.Metadata.init) {
		this.entityId = entityId;
		this.uuid = uuid;
		this.position = position;
		this.yaw = yaw;
...
class Statistics : Buffer {
	...
	public sul.protocol.minecraft210.types.Statistic[] statistics;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(sul.protocol.minecraft210.types.Statistic[] statistics) {
...
class MultiBlockChange : Buffer {
	...
	public pure nothrow @safe @nogc this(Tuple!(int, "x", int, "z") chunk, sul.protocol.minecraft210.types.BlockChange[] changes=(sul.protocol.minecraft210.types.BlockChange[]).init) {
		this.chunk = chunk;
...
class WindowItems : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte window, sul.protocol.minecraft210.types.Slot[] slots=(sul.protocol.minecraft210.types.Slot[]).init) {
		this.window = window;
		this.slots = slots;
	}
...
class SetSlot : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte window, ushort slot=ushort.init, sul.protocol.minecraft210.types.Slot item=sul.protocol.minecraft210.types.Slot.init) {
		this.window = window;
		this.slot = slot;
		this.item = item;
	}
...
class Map : Buffer {
	...
	public sul.protocol.minecraft210.types.Icon[] icons;
	public ubyte colums;
	public ubyte rows;
	...
	public pure nothrow @safe @nogc this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, sul.protocol.minecraft210.types.Icon[] icons=(sul.protocol.minecraft210.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "x", ubyte, "z") offset=Tuple!(ubyte, "x", ubyte, "z").init, ubyte[] data=(ubyte[]).init) {
		this.mapId = mapId;
		this.scale = scale;
...
class PlayerListItem : Buffer {
	...
	public class AddPlayer {
		...
		public pure nothrow @safe @nogc this(sul.protocol.minecraft210.types.ListAddPlayer[] players) {
	...
	public class UpdateGamemode {
		...
		public pure nothrow @safe @nogc this(sul.protocol.minecraft210.types.ListUpdateGamemode[] players) {
			this.players = players;
		}
	...
	public class UpdateLatency {
		...
		public pure nothrow @safe @nogc this(sul.protocol.minecraft210.types.ListUpdateLatency[] players) {
			this.players = players;
		}
	...
	public class UpdateDisplayName {
		...
		public pure nothrow @safe @nogc this(sul.protocol.minecraft210.types.ListUpdateDisplayName[] players) {
			this.players = players;
		}
...
class EntityMetadata : Buffer {
	...
	public pure nothrow @safe @nogc this(uint entityId, sul.protocol.minecraft210.types.Metadata metadata=sul.protocol.minecraft210.types.Metadata.init) {
		this.entityId = entityId;
		this.metadata = metadata;
	}
...
class EntityEquipment : Buffer {
	...
	public pure nothrow @safe @nogc this(uint entityId, uint slot=uint.init, sul.protocol.minecraft210.types.Slot item=sul.protocol.minecraft210.types.Slot.init) {
		this.entityId = entityId;
		this.slot = slot;
		this.item = item;
	}
...
class EntityProperties : Buffer {
	...
	public pure nothrow @safe @nogc this(uint entityId, sul.protocol.minecraft210.types.Property[] properties=(sul.protocol.minecraft210.types.Property[]).init) {
		this.entityId = entityId;
