...
class Add : Buffer {
	...
	public pure nothrow @safe ubyte[] encode(bool writeId=true)() {
		...
		if(reason!=0){ writeBigEndianUbyte(dimension); }
	...
	public pure nothrow @safe void decode(bool readId=true)() {
		...
		if(reason!=0){ dimension=readBigEndianUbyte(); }
...
class UpdateWorld : Buffer {
	...
	public enum string[] FIELDS = ["hubId", "world"];
	...
	public pure nothrow @safe @nogc this(uint hubId, uint world=uint.init) {
		this.hubId = hubId;
		this.world = world;
	}
	...
	public pure nothrow @safe ubyte[] encode(bool writeId=true)() {
		...
		static if(writeId){ writeBigEndianUbyte(ID); }
		writeBytes(varuint.encode(hubId));
		writeBytes(varuint.encode(world));
		return _buffer;
	}
	...
	public pure nothrow @safe void decode(bool readId=true)() {
		static if(readId){ ubyte _id; _id=readBigEndianUbyte(); }
		hubId=varuint.decode(_buffer, &_index);
		world=varuint.decode(_buffer, &_index);
	}
	...
	public override string toString() {
		return "UpdateWorld(hubId: " ~ std.conv.to!string(this.hubId) ~ ", world: " ~ std.conv.to!string(this.world) ~ ")";
	}
...
class UpdateGamemode : Buffer {
	...
	public enum string[] FIELDS = ["hubId", "gamemode"];
	...
	public pure nothrow @safe @nogc this(uint hubId, ubyte gamemode=ubyte.init) {
		this.hubId = hubId;
	...
	public override string toString() {
		return "UpdateGamemode(hubId: " ~ std.conv.to!string(this.hubId) ~ ", gamemode: " ~ std.conv.to!string(this.gamemode) ~ ")";
	}
