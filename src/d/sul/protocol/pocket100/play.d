...
class FullChunkData : Buffer {
	...
	public pure nothrow @safe @nogc this(Tuple!(int, "x", int, "z") position, sul.protocol.pocket100.types.ChunkData data=sul.protocol.pocket100.types.ChunkData.init, ubyte[] tiles=(ubyte[]).init) {
		this.position = position;
		this.data = data;
		this.tiles = tiles;
	}
