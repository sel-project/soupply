...
class SpawnMob : Buffer {
	...
	public Tuple!(short, "x", short, "y", short, "z") velocity;
	public sul.protocol.minecraft108.types.Metadata metadata;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(uint entityId, UUID uuid=UUID.init, ubyte type=ubyte.init, Tuple!(double, "x", double, "y", double, "z") position=Tuple!(double, "x", double, "y", double, "z").init, ubyte yaw=ubyte.init, ubyte pitch=ubyte.init, ubyte headPitch=ubyte.init, Tuple!(short, "x", short, "y", short, "z") velocity=Tuple!(short, "x", short, "y", short, "z").init, sul.protocol.minecraft108.types.Metadata metadata=sul.protocol.minecraft108.types.Metadata.init) {
		this.entityId = entityId;
		this.uuid = uuid;
		this.type = type;
		this.position = position;
...
class SpawnPlayer : Buffer {
	...
	public pure nothrow @safe @nogc this(uint entityId, UUID uuid=UUID.init, Tuple!(double, "x", double, "y", double, "z") position=Tuple!(double, "x", double, "y", double, "z").init, ubyte yaw=ubyte.init, ubyte pitch=ubyte.init, sul.protocol.minecraft108.types.Metadata metadata=sul.protocol.minecraft108.types.Metadata.init) {
		this.entityId = entityId;
		this.uuid = uuid;
		this.position = position;
		this.yaw = yaw;
...
class Statistics : Buffer {
	...
	public sul.protocol.minecraft108.types.Statistic[] statistics;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(sul.protocol.minecraft108.types.Statistic[] statistics) {
...
class MultiBlockChange : Buffer {
	...
	public sul.protocol.minecraft108.types.BlockChange[] changes;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(Tuple!(int, "x", int, "z") chunk, sul.protocol.minecraft108.types.BlockChange[] changes=(sul.protocol.minecraft108.types.BlockChange[]).init) {
		this.chunk = chunk;
...
class WindowItems : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte window, sul.protocol.minecraft108.types.Slot[] slots=(sul.protocol.minecraft108.types.Slot[]).init) {
		this.window = window;
		this.slots = slots;
	}
...
class SetSlot : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte window, ushort slot=ushort.init, sul.protocol.minecraft108.types.Slot item=sul.protocol.minecraft108.types.Slot.init) {
		this.window = window;
		this.slot = slot;
		this.item = item;
	}
...
class Map : Buffer {
	...
	public sul.protocol.minecraft108.types.Icon[] icons;
	public ubyte colums;
	public ubyte rows;
	...
	public pure nothrow @safe @nogc this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, sul.protocol.minecraft108.types.Icon[] icons=(sul.protocol.minecraft108.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "x", ubyte, "z") offset=Tuple!(ubyte, "x", ubyte, "z").init, ubyte[] data=(ubyte[]).init) {
		this.mapId = mapId;
		this.scale = scale;
...
class PlayerListItem : Buffer {
	...
	public class AddPlayer {
		...
		public pure nothrow @safe @nogc this(sul.protocol.minecraft108.types.ListAddPlayer[] players) {
	...
	public class UpdateGamemode {
		...
		public pure nothrow @safe @nogc this(sul.protocol.minecraft108.types.ListUpdateGamemode[] players) {
			this.players = players;
		}
	...
	public class UpdateLatency {
		...
		public pure nothrow @safe @nogc this(sul.protocol.minecraft108.types.ListUpdateLatency[] players) {
			this.players = players;
		}
	...
	public class UpdateDisplayName {
		...
		public pure nothrow @safe @nogc this(sul.protocol.minecraft108.types.ListUpdateDisplayName[] players) {
			this.players = players;
		}
...
class EntityMetadata : Buffer {
	...
	public pure nothrow @safe @nogc this(uint entityId, sul.protocol.minecraft108.types.Metadata metadata=sul.protocol.minecraft108.types.Metadata.init) {
		this.entityId = entityId;
		this.metadata = metadata;
	}
...
class EntityEquipment : Buffer {
	...
	public pure nothrow @safe @nogc this(uint entityId, uint slot=uint.init, sul.protocol.minecraft108.types.Slot item=sul.protocol.minecraft108.types.Slot.init) {
		this.entityId = entityId;
		this.slot = slot;
		this.item = item;
	}
...
class SetPassengers : Buffer {
	...
	public pure nothrow @safe ubyte[] encode(bool writeId=true)() {
		...
		static if(writeId){ writeBytes(varuint.encode(ID)); }
		writeBytes(varuint.encode(entityId));
		writeBytes(varuint.encode(cast(uint)passengers.length)); foreach(cgfzc2vuz2vycw;passengers){ writeBytes(varuint.encode(cgfzc2vuz2vycw)); }
		return _buffer;
	}
...
class EntityProperties : Buffer {
	...
	public pure nothrow @safe @nogc this(uint entityId, sul.protocol.minecraft108.types.Property[] properties=(sul.protocol.minecraft108.types.Property[]).init) {
		this.entityId = entityId;
