...
class ClickWindow : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte window, ushort slot=ushort.init, ubyte button=ubyte.init, ushort action=ushort.init, uint mode=uint.init, sul.protocol.minecraft109.types.Slot clickedItem=sul.protocol.minecraft109.types.Slot.init) {
		this.window = window;
		this.slot = slot;
		this.button = button;
		this.action = action;
...
class CreativeInventoryAction : Buffer {
	...
	public pure nothrow @safe @nogc this(ushort slot, sul.protocol.minecraft109.types.Slot clickedItem=sul.protocol.minecraft109.types.Slot.init) {
		this.slot = slot;
		this.clickedItem = clickedItem;
	}
