...
class Metadata {
	...
	private Changed!(uint) _zombieType;
	...
	public pure nothrow @property @safe sul.protocol.minecraft210.types.Slot potion(sul.protocol.minecraft210.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe sul.protocol.minecraft210.types.OptionalPosition beamTarget(sul.protocol.minecraft210.types.OptionalPosition value) {
		this._cached = false;
	...
	public pure nothrow @property @safe sul.protocol.minecraft210.types.Slot firework(sul.protocol.minecraft210.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe sul.protocol.minecraft210.types.Slot item(sul.protocol.minecraft210.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc uint horseType() {
		return _horseType.value;
	}

	public pure nothrow @property @safe uint horseType(uint value) {
		this._cached = false;
		this._horseType.value = value;
		if(!this._horseType.changed) {
			this._horseType.changed = true;
			this._changed ~= &this.encodeHorseType;
		}
		return value;
	}

	public pure nothrow @safe encodeHorseType(Buffer buffer) {
		with(buffer) {
			writeBigEndianUbyte(14);
			writeBigEndianUbyte(1);
			writeBytes(varuint.encode(this._horseType.value));
		}
	}
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft210.types.OptionalUuid ownerUuid() {
		return _ownerUuid.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft210.types.OptionalUuid ownerUuid(sul.protocol.minecraft210.types.OptionalUuid value) {
		this._cached = false;
	...
	public pure nothrow @property @safe sul.protocol.minecraft210.types.OptionalPosition shulkerAttachment(sul.protocol.minecraft210.types.OptionalPosition value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc byte guardianFlags() {
		return _guardianFlags.value;
	}

	public pure nothrow @property @safe byte guardianFlags(byte value) {
		this._cached = false;
		this._guardianFlags.value = value;
		if(!this._guardianFlags.changed) {
			this._guardianFlags.changed = true;
			this._changed ~= &this.encodeGuardianFlags;
		}
		return value;
	}

	public pure nothrow @safe encodeGuardianFlags(Buffer buffer) {
		with(buffer) {
			writeBigEndianUbyte(12);
			writeBigEndianUbyte(0);
			writeBigEndianByte(this._guardianFlags.value);
		}
	}
	...
	public pure nothrow @property @safe @nogc uint skeletonType() {
		return _skeletonType.value;
	}

	public pure nothrow @property @safe uint skeletonType(uint value) {
		this._cached = false;
		this._skeletonType.value = value;
		if(!this._skeletonType.changed) {
			this._skeletonType.changed = true;
			this._changed ~= &this.encodeSkeletonType;
		}
		return value;
	}

	public pure nothrow @safe encodeSkeletonType(Buffer buffer) {
		with(buffer) {
			writeBigEndianUbyte(12);
			writeBigEndianUbyte(1);
			writeBytes(varuint.encode(this._skeletonType.value));
		}
	}
	...
	public pure nothrow @property @safe @nogc uint zombieType() {
		return _zombieType.value;
	}

	public pure nothrow @property @safe uint zombieType(uint value) {
		this._cached = false;
		this._zombieType.value = value;
		if(!this._zombieType.changed) {
			this._zombieType.changed = true;
			this._changed ~= &this.encodeZombieType;
		}
		return value;
	}

	public pure nothrow @safe encodeZombieType(Buffer buffer) {
		with(buffer) {
			writeBigEndianUbyte(13);
			writeBigEndianUbyte(1);
			writeBytes(varuint.encode(this._zombieType.value));
		}
	}
