...
class Metadata {
	...
	public pure nothrow @property @safe sul.protocol.minecraft315.types.Slot potion(sul.protocol.minecraft315.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe sul.protocol.minecraft315.types.OptionalPosition beamTarget(sul.protocol.minecraft315.types.OptionalPosition value) {
		this._cached = false;
	...
	public pure nothrow @property @safe sul.protocol.minecraft315.types.Slot firework(sul.protocol.minecraft315.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe sul.protocol.minecraft315.types.Slot item(sul.protocol.minecraft315.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe sul.protocol.minecraft315.types.OptionalUuid ownerUuid(sul.protocol.minecraft315.types.OptionalUuid value) {
		this._cached = false;
	...
	public pure nothrow @property @safe sul.protocol.minecraft315.types.OptionalPosition shulkerAttachment(sul.protocol.minecraft315.types.OptionalPosition value) {
		this._cached = false;
